...
public class Threadingclassfine implements Runnable {

	// variables specific to this class.
	private ConcurrentHashMap<String, Double[]> acc_structure;
	private ConcurrentHashMap<String, Double> output_hmap;
	...
	public Threadingclassfine(ConcurrentHashMap<String, Double[]> acc, ConcurrentHashMap<String, Double> output,
	...
	public void calc_average(ConcurrentHashMap<String, Double[]> sum_of_temp) {
	...
	public void print(ConcurrentHashMap<String, Double> output) {
		Set<String> keys = output.keySet();
		for (String key : keys) {
			System.out.println("The Average for key : " + key + " in Fine lock execution is : " + output.get(key));
		}
	}
}
